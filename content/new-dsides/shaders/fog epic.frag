...
/// Cloud stuff:
const float maximum = 0.0/1.0 + 1.0/2.0 + 1.0/3.0 + 1.0/4.0 + 1.0/5.0 + 1.0/6.0 + 1.0/7.0 + 1.0/8.0;
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	fragColor = vec4(q-(customred), q-(customgreen), q-(customblue), texture(iChannel0, fragCoord / iResolution.xy).a);
}
